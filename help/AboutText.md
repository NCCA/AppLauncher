...
You can run houdini from the terminal using goHoudini, there is also a houdini shell you can run as a seperate process in Apps'Ere as well as following instructions [here](https://nccastaff.bournemouth.ac.uk/jmacey/post/desktopIcons/DesktopIcons/)
...
The current version of [MudBox](https://help.autodesk.com/view/MBXPRO/ENU/) is 2025 it is a digital sculpting program similar to ZBrush (which is not avaliable on Linux).
...
The current version of [Davinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve) is 20. It is used for video editing, colour correction, (VFX), motion graphics, and audio post-production. It is similar to Premier pro which is not avaliable for Linux.
